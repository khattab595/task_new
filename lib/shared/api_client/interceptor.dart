...
class UserInterceptor extends Interceptor {
  ...
  UserInterceptor({this.onRequestCallback, this.onResponseCallback, this.onErrorCallback, required this.onRetry});
...
class PrettyDioLogger extends Interceptor {
  ...
  void _printMapAsTable(Map? map, {String? header}) {
    ...
    logPrint('╔ $header ');
    map.forEach((dynamic key, dynamic value) => _printKV(key.toString(), _trimString(value)));
    _printLine('╚');
  }
}
