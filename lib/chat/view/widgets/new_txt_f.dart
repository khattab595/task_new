...
class KChatTextFormField extends StatefulWidget {
  ...
  @override
  State<KChatTextFormField> createState() => _KChatTextFormFieldState();
}

class _KChatTextFormFieldState extends State<KChatTextFormField> {
